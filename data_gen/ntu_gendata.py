...
from data_gen.preprocess import pre_normalization,sample_pre_normalization
...
def gendata(data_path, out_path, ignored_sample_path=None, benchmark='xview', part='eval'):
    ...
    np.save('{}/{}_data_joint_origin.npy'.format(out_path, part), fp)
    fp = pre_normalization(fp)
    np.save('{}/{}_data_joint.npy'.format(out_path, part), fp)
# def process_data(data_path, out_path, ignored_sample_path=None, benchmark='xview', part='eval'):
#     fp = np.load('{}/{}_data_joint_origin.npy'.format(out_path, part))
#     fp = sample_pre_normalization(fp,num_sample=48)
#     # fp = pre_normalization(fp)
#     np.save('{}/{}_data_joint_sample_pre.npy'.format(out_path, part), fp)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_folder', default='../data/ntu_subsample/')
